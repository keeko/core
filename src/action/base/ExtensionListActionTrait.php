...
/**
 * Base methods for keeko\core\action\ExtensionListAction
 * 
 * This code is automatically created. Modifications will probably be overwritten.
 * 
 * @author gossi
 */
trait ExtensionListActionTrait {
	 ...
	 */
	public function applyFilter(ExtensionQuery $query) {
	}
	...
	public function run(Request $request) {
		...
		// paginate
		$extension = $query->paginate($page, $pageSize);
