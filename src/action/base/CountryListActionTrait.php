...
/**
 * Base methods for keeko\core\action\CountryListAction
 * 
 * This code is automatically created. Modifications will probably be overwritten.
 * 
 * @author gossi
 */
trait CountryListActionTrait {
	 ...
	 */
	public function applyFilter(CountryQuery $query) {
	}
	...
	public function run(Request $request) {
		...
		// paginate
		$country = $query->paginate($page, $pageSize);
