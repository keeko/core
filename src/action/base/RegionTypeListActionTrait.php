...
/**
 * Base methods for keeko\core\action\RegionTypeListAction
 * 
 * This code is automatically created. Modifications will probably be overwritten.
 * 
 * @author gossi
 */
trait RegionTypeListActionTrait {
	 ...
	 */
	public function applyFilter(RegionTypeQuery $query) {
	}
	...
	public function run(Request $request) {
		...
		// paginate
		$regionType = $query->paginate($page, $pageSize);
