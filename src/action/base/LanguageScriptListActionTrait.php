...
/**
 * Base methods for keeko\core\action\LanguageScriptListAction
 * 
 * This code is automatically created. Modifications will probably be overwritten.
 * 
 * @author gossi
 */
trait LanguageScriptListActionTrait {
	 ...
	 */
	public function applyFilter(LanguageScriptQuery $query) {
	}
	...
	public function run(Request $request) {
		...
		// paginate
		$languageScript = $query->paginate($page, $pageSize);
