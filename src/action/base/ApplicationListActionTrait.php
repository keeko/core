...
/**
 * Base methods for keeko\core\action\ApplicationListAction
 * 
 * This code is automatically created. Modifications will probably be overwritten.
 * 
 * @author gossi
 */
trait ApplicationListActionTrait {
	 ...
	 */
	public function applyFilter(ApplicationQuery $query) {
	}
	...
	public function run(Request $request) {
		...
		// paginate
		$application = $query->paginate($page, $pageSize);
