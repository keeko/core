...
/**
 * Base class that represents a row from the 'kk_subdivision_type' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class SubdivisionType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\keeko\\core\\model\\Map\\SubdivisionTypeTableMap';
    ...
    /**
     * Initializes internal state of keeko\core\model\Base\SubdivisionType object.
     */
    ...
    /**
     * Compares this with another <code>SubdivisionType</code> instance.  If
     * <code>obj</code> is an instance of <code>SubdivisionType</code>, delegates to
     * <code>equals(SubdivisionType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SubdivisionType The current object, for fluid interface
     */
     ...
     * @return $this|\keeko\core\model\SubdivisionType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SubdivisionTypeTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[SubdivisionTypeTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SubdivisionTypeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SubdivisionTypeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = SubdivisionTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\keeko\\core\\model\\SubdivisionType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSubdivisionTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SubdivisionType::setDeleted()
     * @see SubdivisionType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSubdivisionTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SubdivisionTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[SubdivisionTypeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SubdivisionTypeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(SubdivisionTypeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(SubdivisionTypeTableMap::COL_NAME)) {
    ...
    {
        $pos = SubdivisionTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SubdivisionType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SubdivisionType'][$this->hashCode()] = true;
        $keys = SubdivisionTypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\keeko\core\model\SubdivisionType
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\keeko\core\model\SubdivisionType The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(SubdivisionTypeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(SubdivisionTypeTableMap::COL_ID)) {
            $criteria->add(SubdivisionTypeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SubdivisionTypeTableMap::COL_NAME)) {
            $criteria->add(SubdivisionTypeTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildSubdivisionTypeQuery::create();
        $criteria->add(SubdivisionTypeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \keeko\core\model\SubdivisionType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \keeko\core\model\SubdivisionType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildSubdivisionType is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSubdivisionType The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(SubdivisionTypeTableMap::DEFAULT_STRING_FORMAT);
    }
