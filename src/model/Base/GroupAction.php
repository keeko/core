...
abstract class GroupAction implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\keeko\\core\\model\\Map\\GroupActionTableMap';
    ...
    /**
     * Initializes internal state of keeko\core\model\Base\GroupAction object.
     */
    ...
    /**
     * Compares this with another <code>GroupAction</code> instance.  If
     * <code>obj</code> is an instance of <code>GroupAction</code>, delegates to
     * <code>equals(GroupAction)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|GroupAction The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GroupActionTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GroupActionTableMap::translateFieldName('ActionId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = GroupActionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\keeko\\core\\model\\GroupAction'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGroupActionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see GroupAction::setDeleted()
     * @see GroupAction::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGroupActionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GroupActionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = GroupActionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        return (null === $this->getGroupId()) && (null === $this->getActionId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \keeko\core\model\GroupAction (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \keeko\core\model\GroupAction Clone of current object.
     * @throws PropelException
     */
    ...
    public function getGroup(ConnectionInterface $con = null)
    {
        if ($this->aGroup === null && ($this->group_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGroup->addGroupActions($this);
             */
        }
    ...
    public function getAction(ConnectionInterface $con = null)
    {
        if ($this->aAction === null && ($this->action_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAction->addGroupActions($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(GroupActionTableMap::DEFAULT_STRING_FORMAT);
    }
