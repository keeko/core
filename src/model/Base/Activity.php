...
/**
 * Base class that represents a row from the 'kk_activity' table.
 *
 *
 *
...
abstract class Activity implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\keeko\\core\\model\\Map\\ActivityTableMap';
    ...
    /**
     * Initializes internal state of keeko\core\model\Base\Activity object.
     */
    ...
    public function setActorId($v)
    {
        ...
        if ($this->actor_id !== $v) {
            $this->actor_id = $v;
            $this->modifiedColumns[ActivityTableMap::COL_ACTOR_ID] = true;
        }
    ...
    public function setVerb($v)
    {
        ...
        if ($this->verb !== $v) {
            $this->verb = $v;
            $this->modifiedColumns[ActivityTableMap::COL_VERB] = true;
        }
    ...
    public function setTargetId($v)
    {
        ...
        if ($this->target_id !== $v) {
            $this->target_id = $v;
            $this->modifiedColumns[ActivityTableMap::COL_TARGET_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ActivityTableMap::translateFieldName('ActorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->actor_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ActivityTableMap::translateFieldName('Verb', TableMap::TYPE_PHPNAME, $indexType)];
            $this->verb = (null !== $col) ? (string) $col : null;
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ActivityTableMap::COL_ACTOR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`actor_id`';
        }
        if ($this->isColumnModified(ActivityTableMap::COL_VERB)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\keeko\core\model\Activity
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setActorId($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setVerb($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\keeko\core\model\Activity The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ActivityTableMap::COL_ACTOR_ID)) {
            $criteria->add(ActivityTableMap::COL_ACTOR_ID, $this->actor_id);
        }
        if ($this->isColumnModified(ActivityTableMap::COL_VERB)) {
            $criteria->add(ActivityTableMap::COL_VERB, $this->verb);
        }
        if ($this->isColumnModified(ActivityTableMap::COL_OBJECT_ID)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \keeko\core\model\Activity (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \keeko\core\model\Activity Clone of current object.
     * @throws PropelException
     */
    ...
    public function getActor(ConnectionInterface $con = null)
    {
        if ($this->aActor === null && ($this->actor_id !== null)) {
            $this->aActor = ChildUserQuery::create()->findPk($this->actor_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aActor->addActivities($this);
             */
        }
    ...
    /**
     * Get the associated ChildActivityObject object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildActivityObject The associated ChildActivityObject object.
     * @throws PropelException
     */
    public function getObject(ConnectionInterface $con = null)
    {
        if ($this->aObject === null && ($this->object_id !== null)) {
            $this->aObject = ChildActivityObjectQuery::create()->findPk($this->object_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aObject->addActivitiesRelatedByObjectId($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setTarget(ChildActivityObject $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ChildActivityObject object, it will not be re-added.
        if ($v !== null) {
            $v->addActivityRelatedByTargetId($this);
        }
    ...
    public function getTarget(ConnectionInterface $con = null)
    {
        if ($this->aTarget === null && ($this->target_id !== null)) {
            $this->aTarget = ChildActivityObjectQuery::create()->findPk($this->target_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTarget->addActivitiesRelatedByTargetId($this);
             */
        }
