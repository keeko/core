...
/**
 * Base class that represents a row from the 'kk_session' table.
 *
 *
 *
...
abstract class Session implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\keeko\\core\\model\\Map\\SessionTableMap';
    ...
    /**
     * Initializes internal state of keeko\core\model\Base\Session object.
     */
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `kk_session` (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\keeko\core\model\Session
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\keeko\core\model\Session The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \keeko\core\model\Session (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \keeko\core\model\Session Clone of current object.
     * @throws PropelException
     */
