 ...
 *
 * @method     ChildGroupQuery leftJoinGroupAction($relationAlias = null) Adds a LEFT JOIN clause to the query using the GroupAction relation
 ...
 *
 * @method     \keeko\core\model\UserGroupQuery|\keeko\core\model\GroupActionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class GroupQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'keeko', $modelName = '\\keeko\\core\\model\\Group', $modelAlias = null)
    {
    ...
    public function filterByIsGuest($isGuest = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(GroupTableMap::COL_IS_GUEST, $isGuest, $comparison);
    }
    ...
    public function filterByIsDefault($isDefault = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(GroupTableMap::COL_IS_DEFAULT, $isDefault, $comparison);
    }
    ...
    public function filterByIsActive($isActive = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(GroupTableMap::COL_IS_ACTIVE, $isActive, $comparison);
    }
    ...
    public function filterByIsSystem($isSystem = null, $comparison = null)
    {
        if (is_string($isSystem)) {
            $isSystem = in_array(strtolower($isSystem), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(GroupTableMap::COL_IS_SYSTEM, $isSystem, $comparison);
    }
    ...
    public function filterByGroupAction($groupAction, $comparison = null)
    {
        if ($groupAction instanceof \keeko\core\model\GroupAction) {
            return $this
                ->addUsingAlias(GroupTableMap::COL_ID, $groupAction->getGroupId(), $comparison);
