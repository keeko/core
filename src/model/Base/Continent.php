...
/**
 * Base class that represents a row from the 'kk_continent' table.
 *
 *
 *
...
abstract class Continent implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\keeko\\core\\model\\Map\\ContinentTableMap';
    ...
    /**
     * Initializes internal state of keeko\core\model\Base\Continent object.
     */
     ...
     * @return $this|\keeko\core\model\Continent The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ContinentTableMap::COL_ID] = true;
        }
    ...
    public function setParentId($v)
    {
        ...
        if ($this->parent_id !== $v) {
            $this->parent_id = $v;
            $this->modifiedColumns[ContinentTableMap::COL_PARENT_ID] = true;
        }
    ...
    public function setNumeric($v)
    {
        ...
        if ($this->numeric !== $v) {
            $this->numeric = $v;
            $this->modifiedColumns[ContinentTableMap::COL_NUMERIC] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ContinentTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ContinentTableMap::translateFieldName('ParentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->parent_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ContinentTableMap::translateFieldName('Numeric', TableMap::TYPE_PHPNAME, $indexType)];
            $this->numeric = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ContinentTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = ContinentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\keeko\\core\\model\\Continent'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ContinentTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ContinentTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ContinentTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ContinentTableMap::COL_PARENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`parent_id`';
        }
        if ($this->isColumnModified(ContinentTableMap::COL_NUMERIC)) {
        ...
        $sql = sprintf(
            'INSERT INTO `kk_continent` (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\keeko\core\model\Continent
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\keeko\core\model\Continent The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContinentTableMap::COL_ID)) {
            $criteria->add(ContinentTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ContinentTableMap::COL_PARENT_ID)) {
            $criteria->add(ContinentTableMap::COL_PARENT_ID, $this->parent_id);
        }
        if ($this->isColumnModified(ContinentTableMap::COL_NUMERIC)) {
            $criteria->add(ContinentTableMap::COL_NUMERIC, $this->numeric);
        }
        if ($this->isColumnModified(ContinentTableMap::COL_NAME)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \keeko\core\model\Continent (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \keeko\core\model\Continent Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildContinent is new, it will return
    ...
    public function setCountries(Collection $countries, ConnectionInterface $con = null)
    {
        ...
        foreach ($countriesToDelete as $countryRemoved) {
            $countryRemoved->setContinent(null);
        }
     ...
     * Otherwise if this Continent is new, it will return
     * an empty collection; or if this Continent has previously
     * been saved, it will retrieve related Countries from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Continent.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
