...
/**
 * Base class that represents a row from the 'kk_language_scope' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class LanguageScope implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\keeko\\core\\model\\Map\\LanguageScopeTableMap';
    ...
    /**
     * Initializes internal state of keeko\core\model\Base\LanguageScope object.
     */
    ...
    /**
     * Compares this with another <code>LanguageScope</code> instance.  If
     * <code>obj</code> is an instance of <code>LanguageScope</code>, delegates to
     * <code>equals(LanguageScope)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|LanguageScope The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LanguageScopeTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[LanguageScopeTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LanguageScopeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LanguageScopeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = LanguageScopeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\keeko\\core\\model\\LanguageScope'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLanguageScopeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LanguageScope::setDeleted()
     * @see LanguageScope::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getWriteConnection(LanguageScopeTableMap::DATABASE_NAME);
        }

        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLanguageScopeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LanguageScopeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[LanguageScopeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . LanguageScopeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(LanguageScopeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LanguageScopeTableMap::COL_NAME)) {
    ...
    {
        $pos = LanguageScopeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['LanguageScope'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LanguageScope'][$this->hashCode()] = true;
        $keys = LanguageScopeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\keeko\core\model\LanguageScope
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\keeko\core\model\LanguageScope The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(LanguageScopeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(LanguageScopeTableMap::COL_ID)) {
            $criteria->add(LanguageScopeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(LanguageScopeTableMap::COL_NAME)) {
            $criteria->add(LanguageScopeTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildLanguageScopeQuery::create();
        $criteria->add(LanguageScopeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \keeko\core\model\LanguageScope (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \keeko\core\model\LanguageScope Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildLanguageScope is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildLanguageScope The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(LanguageScopeTableMap::DEFAULT_STRING_FORMAT);
    }
