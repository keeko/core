...
/**
 * Base class that represents a row from the 'kk_language_type' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class LanguageType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\keeko\\core\\model\\Map\\LanguageTypeTableMap';
    ...
    /**
     * Initializes internal state of keeko\core\model\Base\LanguageType object.
     */
    ...
    /**
     * Compares this with another <code>LanguageType</code> instance.  If
     * <code>obj</code> is an instance of <code>LanguageType</code>, delegates to
     * <code>equals(LanguageType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|LanguageType The current object, for fluid interface
     */
     ...
     * @return $this|\keeko\core\model\LanguageType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LanguageTypeTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[LanguageTypeTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LanguageTypeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LanguageTypeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = LanguageTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\keeko\\core\\model\\LanguageType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLanguageTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LanguageType::setDeleted()
     * @see LanguageType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLanguageTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LanguageTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LanguageTypeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LanguageTypeTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `kk_language_type` (%s) VALUES (%s)',
    ...
    {
        $pos = LanguageTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['LanguageType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LanguageType'][$this->hashCode()] = true;
        $keys = LanguageTypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\keeko\core\model\LanguageType
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\keeko\core\model\LanguageType The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LanguageTypeTableMap::COL_ID)) {
            $criteria->add(LanguageTypeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(LanguageTypeTableMap::COL_NAME)) {
            $criteria->add(LanguageTypeTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildLanguageTypeQuery::create();
        $criteria->add(LanguageTypeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \keeko\core\model\LanguageType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \keeko\core\model\LanguageType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildLanguageType is new, it will return
    ...
    {
        return (string) $this->exportTo(LanguageTypeTableMap::DEFAULT_STRING_FORMAT);
    }
