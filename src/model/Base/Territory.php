...
/**
 * Base class that represents a row from the 'kk_territory' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Territory implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\keeko\\core\\model\\Map\\TerritoryTableMap';
    ...
    /**
     * Initializes internal state of keeko\core\model\Base\Territory object.
     */
    ...
    /**
     * Compares this with another <code>Territory</code> instance.  If
     * <code>obj</code> is an instance of <code>Territory</code>, delegates to
     * <code>equals(Territory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Territory The current object, for fluid interface
     */
    ...
    public function setIsoNr($v)
    {
        ...
        if ($this->iso_nr !== $v) {
            $this->iso_nr = $v;
            $this->modifiedColumns[TerritoryTableMap::COL_ISO_NR] = true;
        }
    ...
    public function setParentIsoNr($v)
    {
        ...
        if ($this->parent_iso_nr !== $v) {
            ...
            $this->modifiedColumns[TerritoryTableMap::COL_PARENT_ISO_NR] = true;
        }
    ...
    public function setNameEn($v)
    {
        ...
        if ($this->name_en !== $v) {
            $this->name_en = $v;
            $this->modifiedColumns[TerritoryTableMap::COL_NAME_EN] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TerritoryTableMap::translateFieldName('IsoNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iso_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TerritoryTableMap::translateFieldName('ParentIsoNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->parent_iso_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TerritoryTableMap::translateFieldName('NameEn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_en = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = TerritoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\keeko\\core\\model\\Territory'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTerritoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Territory::setDeleted()
     * @see Territory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTerritoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TerritoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TerritoryTableMap::COL_ISO_NR)) {
            $modifiedColumns[':p' . $index++]  = '`iso_nr`';
        }
        if ($this->isColumnModified(TerritoryTableMap::COL_PARENT_ISO_NR)) {
            $modifiedColumns[':p' . $index++]  = '`parent_iso_nr`';
        }
        if ($this->isColumnModified(TerritoryTableMap::COL_NAME_EN)) {
    ...
    {
        $pos = TerritoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Territory'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Territory'][$this->hashCode()] = true;
        $keys = TerritoryTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\keeko\core\model\Territory
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setParentIsoNr($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setNameEn($arr[$keys[2]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\keeko\core\model\Territory The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TerritoryTableMap::COL_ISO_NR)) {
            $criteria->add(TerritoryTableMap::COL_ISO_NR, $this->iso_nr);
        }
        if ($this->isColumnModified(TerritoryTableMap::COL_PARENT_ISO_NR)) {
            $criteria->add(TerritoryTableMap::COL_PARENT_ISO_NR, $this->parent_iso_nr);
        }
        if ($this->isColumnModified(TerritoryTableMap::COL_NAME_EN)) {
            $criteria->add(TerritoryTableMap::COL_NAME_EN, $this->name_en);
        }
    ...
    {
        $criteria = ChildTerritoryQuery::create();
        $criteria->add(TerritoryTableMap::COL_ISO_NR, $this->iso_nr);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \keeko\core\model\Territory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \keeko\core\model\Territory Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTerritory is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTerritory The current object (for fluent API support)
     */
     ...
     * @return ObjectCollection|ChildCountry[] List of ChildCountry objects
     */
    public function getCountriesJoinCurrency(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCountryQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(TerritoryTableMap::DEFAULT_STRING_FORMAT);
    }
