...
/**
 * Base class that represents a row from the 'kk_action' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Action implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\keeko\\core\\model\\Map\\ActionTableMap';
    ...
    /**
     * Initializes internal state of keeko\core\model\Base\Action object.
     */
    ...
    /**
     * Compares this with another <code>Action</code> instance.  If
     * <code>obj</code> is an instance of <code>Action</code>, delegates to
     * <code>equals(Action)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Action The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ActionTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ActionTableMap::COL_NAME] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[ActionTableMap::COL_TITLE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[ActionTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setClassName($v)
    {
        ...
        if ($this->class_name !== $v) {
            $this->class_name = $v;
            $this->modifiedColumns[ActionTableMap::COL_CLASS_NAME] = true;
        }
    ...
    public function setModuleId($v)
    {
        ...
        if ($this->module_id !== $v) {
            $this->module_id = $v;
            $this->modifiedColumns[ActionTableMap::COL_MODULE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ActionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ActionTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ActionTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ActionTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ActionTableMap::translateFieldName('ClassName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->class_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ActionTableMap::translateFieldName('ModuleId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = ActionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\keeko\\core\\model\\Action'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildActionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Action::setDeleted()
     * @see Action::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildActionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ActionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->apisScheduledForDeletion !== null) {
                if (!$this->apisScheduledForDeletion->isEmpty()) {
                    \keeko\core\model\ApiQuery::create()
                        ->filterByPrimaryKeys($this->apisScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ActionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ActionTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ActionTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(ActionTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(ActionTableMap::COL_CLASS_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`class_name`';
        }
        if ($this->isColumnModified(ActionTableMap::COL_MODULE_ID)) {
    ...
    {
        $pos = ActionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Action'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Action'][$this->hashCode()] = true;
        $keys = ActionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aModule) {
                ...
                $result[$key] = $this->aModule->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->collApis) {
                ...
                $result[$key] = $this->collApis->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\keeko\core\model\Action
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\keeko\core\model\Action The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ActionTableMap::COL_ID)) {
            $criteria->add(ActionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ActionTableMap::COL_NAME)) {
            $criteria->add(ActionTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ActionTableMap::COL_TITLE)) {
            $criteria->add(ActionTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(ActionTableMap::COL_DESCRIPTION)) {
            $criteria->add(ActionTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(ActionTableMap::COL_CLASS_NAME)) {
            $criteria->add(ActionTableMap::COL_CLASS_NAME, $this->class_name);
        }
        if ($this->isColumnModified(ActionTableMap::COL_MODULE_ID)) {
            $criteria->add(ActionTableMap::COL_MODULE_ID, $this->module_id);
        }
    ...
    {
        $criteria = ChildActionQuery::create();
        $criteria->add(ActionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \keeko\core\model\Action (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \keeko\core\model\Action Clone of current object.
     * @throws PropelException
     */
    ...
    public function initApis($overrideExisting = true)
    {
        ...
        $this->collApis->setModel('\keeko\core\model\Api');
    }
     ...
     * @param      ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildApi[] List of ChildApi objects
     * @throws PropelException
     */
    public function getApis(Criteria $criteria = null, ConnectionInterface $con = null)
    {
    ...
    /**
     * Sets a collection of ChildApi objects related by a one-to-many relationship
    ...
    /**
     * @param  ChildApi $api The ChildApi object to remove.
     * @return $this|ChildAction The current object (for fluent API support)
     */
    public function removeApi(ChildApi $api)
    {
        if ($this->getApis()->contains($api)) {
            $pos = $this->collApis->search($api);
            $this->collApis->remove($pos);
            ...
            $this->apisScheduledForDeletion[]= clone $api;
            $api->setAction(null);
        }
     ...
     * @return ObjectCollection|ChildGroupAction[] List of ChildGroupAction objects
     */
    public function getGroupActionsJoinGroup(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildGroupActionQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ActionTableMap::DEFAULT_STRING_FORMAT);
    }
