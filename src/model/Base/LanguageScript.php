...
abstract class LanguageScript implements ActiveRecordInterface
{
     ...
     * ISO 15924 numeric representation
     * @return int
     */
     ...
     * @return ObjectCollection|ChildLocalization[] List of ChildLocalization objects
     */
    public function getLocalizationsJoinParent(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildLocalizationQuery::create(null, $criteria);
        $query->joinWith('Parent', $joinBehavior);
