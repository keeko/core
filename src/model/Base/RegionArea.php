...
/**
 * Base class that represents a row from the 'kk_region_area' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class RegionArea implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\keeko\\core\\model\\Map\\RegionAreaTableMap';
    ...
    /**
     * Compares this with another <code>RegionArea</code> instance.  If
     * <code>obj</code> is an instance of <code>RegionArea</code>, delegates to
     * <code>equals(RegionArea)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|RegionArea The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[RegionAreaTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[RegionAreaTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RegionAreaTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RegionAreaTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = RegionAreaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\keeko\\core\\model\\RegionArea'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRegionAreaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see RegionArea::setDeleted()
     * @see RegionArea::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRegionAreaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RegionAreaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->regionTypesScheduledForDeletion !== null) {
                if (!$this->regionTypesScheduledForDeletion->isEmpty()) {
                    \keeko\core\model\RegionTypeQuery::create()
                        ->filterByPrimaryKeys($this->regionTypesScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->regionTypesScheduledForDeletion = null;
                }
            }

            if ($this->collRegionTypes !== null) {
                foreach ($this->collRegionTypes as $referrerFK) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[RegionAreaTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . RegionAreaTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(RegionAreaTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RegionAreaTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `kk_region_area` (%s) VALUES (%s)',
    ...
    {
        $pos = RegionAreaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['RegionArea'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RegionArea'][$this->hashCode()] = true;
        $keys = RegionAreaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\keeko\core\model\RegionArea
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\keeko\core\model\RegionArea The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(RegionAreaTableMap::DATABASE_NAME);

        if ($this->isColumnModified(RegionAreaTableMap::COL_ID)) {
            $criteria->add(RegionAreaTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(RegionAreaTableMap::COL_NAME)) {
            $criteria->add(RegionAreaTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildRegionAreaQuery::create();
        $criteria->add(RegionAreaTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \keeko\core\model\RegionArea (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \keeko\core\model\RegionArea Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Gets an array of ChildRegionType objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ChildRegionArea is new, it will return
    ...
    /**
     * Sets a collection of ChildRegionType objects related by a one-to-many relationship
    ...
    /**
     * Returns the number of related RegionType objects.
     *
    ...
    /**
     * Method called to associate a ChildRegionType object to this object
     * through the ChildRegionType foreign key attribute.
     *
    ...
    {
        return (string) $this->exportTo(RegionAreaTableMap::DEFAULT_STRING_FORMAT);
    }
