...
abstract class BaseModulePeer
{
    ...
    const ACTIVATED_VERSION = 'keeko_module.activated_version';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Classname', 'ActivatedVersion', 'PackageId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'classname', 'activatedVersion', 'packageId', ),
        BasePeer::TYPE_COLNAME => array (ModulePeer::ID, ModulePeer::CLASSNAME, ModulePeer::ACTIVATED_VERSION, ModulePeer::PACKAGE_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CLASSNAME', 'ACTIVATED_VERSION', 'PACKAGE_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'classname', 'activated_version', 'package_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Classname' => 1, 'ActivatedVersion' => 2, 'PackageId' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'classname' => 1, 'activatedVersion' => 2, 'packageId' => 3, ),
        BasePeer::TYPE_COLNAME => array (ModulePeer::ID => 0, ModulePeer::CLASSNAME => 1, ModulePeer::ACTIVATED_VERSION => 2, ModulePeer::PACKAGE_ID => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CLASSNAME' => 1, 'ACTIVATED_VERSION' => 2, 'PACKAGE_ID' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'classname' => 1, 'activated_version' => 2, 'package_id' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
