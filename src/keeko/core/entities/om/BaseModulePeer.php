...
abstract class BaseModulePeer extends PackagePeer
{
    ...
    const TM_CLASS = 'keeko\\core\\entities\\map\\ModuleTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of Module objects.
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseModulePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \keeko\core\entities\map\ModuleTableMap());
      }
    }
