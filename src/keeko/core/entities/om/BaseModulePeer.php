...
use keeko\core\entities\map\ModuleTableMap;

/**
 * Base static class for performing query and update operations on the 'keeko_module' table.
 *
 *
 *
...
abstract class BaseModulePeer
{
    ...
    const OM_CLASS = 'keeko\\core\\entities\\Module';
    ...
    const UNIXNAME = 'keeko_module.unixname';

    /** the column name for the version field */
    const VERSION = 'keeko_module.version';

    /** the column name for the classname field */
    const CLASSNAME = 'keeko_module.classname';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Unixname', 'Version', 'Classname', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'unixname', 'version', 'classname', ),
        BasePeer::TYPE_COLNAME => array (ModulePeer::ID, ModulePeer::NAME, ModulePeer::UNIXNAME, ModulePeer::VERSION, ModulePeer::CLASSNAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'UNIXNAME', 'VERSION', 'CLASSNAME', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'unixname', 'version', 'classname', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Unixname' => 2, 'Version' => 3, 'Classname' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'unixname' => 2, 'version' => 3, 'classname' => 4, ),
        BasePeer::TYPE_COLNAME => array (ModulePeer::ID => 0, ModulePeer::NAME => 1, ModulePeer::UNIXNAME => 2, ModulePeer::VERSION => 3, ModulePeer::CLASSNAME => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'UNIXNAME' => 2, 'VERSION' => 3, 'CLASSNAME' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'unixname' => 2, 'version' => 3, 'classname' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    /**
     * Method to invalidate the instance pool of all tables related to keeko_module
     * by a foreign key with ON DELETE CASCADE
     */
    public static function clearRelatedInstancePool()
    {
        // Invalidate objects in ActionPeer instance pool,
