...
abstract class BaseLocalization extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'keeko\\core\\entities\\LocalizationPeer';
     ...
     * @throws PropelException
     */
    public function getLocalizationRelatedByParentId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLocalizationRelatedByParentId === null && ($this->parent_id !== null) && $doQuery) {
     ...
     * @return PropelObjectCollection|ApplicationUri[] List of ApplicationUri objects
     */
    public function getApplicationUrisJoinApplication($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ApplicationUriQuery::create(null, $criteria);
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aLocalizationRelatedByParentId instanceof Persistent) {
              $this->aLocalizationRelatedByParentId->clearAllReferences($deep);
            }
