...
abstract class BaseApplicationType extends BaseObject implements Persistent
{
    ...
    public function setClassname($v)
    {
        ...
        if ($this->classname !== $v) {
            $this->classname = $v;
            $this->modifiedColumns[] = ApplicationTypePeer::CLASSNAME;
        }
    ...
    public function setPackageId($v)
    {
        ...
        if ($this->package_id !== $v) {
            $this->package_id = $v;
            $this->modifiedColumns[] = ApplicationTypePeer::PACKAGE_ID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ApplicationTypePeer::CLASSNAME)) {
            $modifiedColumns[':p' . $index++]  = '`classname`';
        }
        if ($this->isColumnModified(ApplicationTypePeer::PACKAGE_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ApplicationTypePeer::CLASSNAME)) $criteria->add(ApplicationTypePeer::CLASSNAME, $this->classname);
        if ($this->isColumnModified(ApplicationTypePeer::PACKAGE_ID)) $criteria->add(ApplicationTypePeer::PACKAGE_ID, $this->package_id);
    ...
    public function getPackage(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPackage === null && ($this->package_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPackage->addApplicationTypes($this);
             */
        }
