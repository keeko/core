...
use keeko\core\entities\map\ActionTableMap;

/**
 * Base static class for performing query and update operations on the 'keeko_action' table.
 *
 *
 *
...
abstract class BaseActionPeer
{
    ...
    const OM_CLASS = 'keeko\\core\\entities\\Action';

    /** the related TableMap class for this table */
    const TM_CLASS = 'keeko\\core\\entities\\map\\ActionTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of Action objects.
    ...
    /**
     * Method to invalidate the instance pool of all tables related to keeko_action
    ...
    public static function doCountJoinModule(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ActionPeer::MODULE_ID, ModulePeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Action objects pre-filled with their Module objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinModule(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Action) to $obj2 (Module)
                $obj2->addAction($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Action) to the collection in $obj2 (Module)
                $obj2->addAction($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseActionPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \keeko\core\entities\map\ActionTableMap());
      }
    }
