...
abstract class BaseSubdivision extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'keeko\\core\\entities\\SubdivisionPeer';
    ...
    {
        if ($this->aCountry === null && ($this->country_iso_nr !== null) && $doQuery) {
     ...
     * @throws PropelException
     */
    public function getSubdivisionType(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSubdivisionType === null && ($this->subdivision_type_id !== null) && $doQuery) {
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aSubdivisionType instanceof Persistent) {
              $this->aSubdivisionType->clearAllReferences($deep);
            }
