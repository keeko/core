...
abstract class BaseLayoutQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'keeko', $modelName = 'keeko\\core\\entities\\Layout', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `title`, `design_id` FROM `keeko_layout` WHERE `id` = :p0';
        try {
