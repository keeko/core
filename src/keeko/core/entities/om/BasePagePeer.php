...
use keeko\core\entities\map\PageTableMap;

/**
 * Base static class for performing query and update operations on the 'keeko_page' table.
 *
 *
 *
...
abstract class BasePagePeer
{
    ...
    const TABLE_NAME = 'keeko_page';

    /** the related Propel class for this table */
    const OM_CLASS = 'keeko\\core\\entities\\Page';

    /** the related TableMap class for this table */
    const TM_CLASS = 'keeko\\core\\entities\\map\\PageTableMap';
    ...
    const SLUG = 'keeko_page.slug';

    /** the column name for the description field */
    const DESCRIPTION = 'keeko_page.description';

    /** the column name for the keywords field */
    const KEYWORDS = 'keeko_page.keywords';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to keeko_page
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinLayout(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinLayout(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Page) to $obj2 (Layout)
                $obj2->addPage($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePagePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \keeko\core\entities\map\PageTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the keeko_page table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
