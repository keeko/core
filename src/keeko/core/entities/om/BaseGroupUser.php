...
/**
 * Base class that represents a row from the 'keeko_group_user' table.
 *
 *
 *
...
abstract class BaseGroupUser extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'keeko\\core\\entities\\GroupUserPeer';
     ...
     * @return GroupUser The current object (for fluent API support)
     */
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = GroupUserPeer::USER_ID;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[] = GroupUserPeer::GROUP_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = GroupUserPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GroupUserPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GroupUserQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GroupUserPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GroupUserPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(GroupUserPeer::GROUP_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupUserPeer::USER_ID)) $criteria->add(GroupUserPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(GroupUserPeer::GROUP_ID)) $criteria->add(GroupUserPeer::GROUP_ID, $this->group_id);
    ...
    {
        $criteria = new Criteria(GroupUserPeer::DATABASE_NAME);
        $criteria->add(GroupUserPeer::USER_ID, $this->user_id);
        $criteria->add(GroupUserPeer::GROUP_ID, $this->group_id);
    ...
    {
        return (string) $this->exportTo(GroupUserPeer::DEFAULT_STRING_FORMAT);
    }
