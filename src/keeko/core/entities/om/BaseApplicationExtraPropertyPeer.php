...
abstract class BaseApplicationExtraPropertyPeer
{
    ...
    const TM_CLASS = 'keeko\\core\\entities\\map\\ApplicationExtraPropertyTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of ApplicationExtraProperty objects.
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseApplicationExtraPropertyPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \keeko\core\entities\map\ApplicationExtraPropertyTableMap());
      }
    }
