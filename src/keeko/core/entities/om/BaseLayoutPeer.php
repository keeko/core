...
abstract class BaseLayoutPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'DesignId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'designId', ),
        BasePeer::TYPE_COLNAME => array (LayoutPeer::ID, LayoutPeer::TITLE, LayoutPeer::DESIGN_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'DESIGN_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'design_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'DesignId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'designId' => 2, ),
        BasePeer::TYPE_COLNAME => array (LayoutPeer::ID => 0, LayoutPeer::TITLE => 1, LayoutPeer::DESIGN_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'DESIGN_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'design_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
