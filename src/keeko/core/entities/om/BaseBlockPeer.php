...
use keeko\core\entities\map\BlockTableMap;

/**
 * Base static class for performing query and update operations on the 'keeko_block' table.
 *
 *
 *
...
abstract class BaseBlockPeer
{
    ...
    const LAYOUT_ID = 'keeko_block.layout_id';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to keeko_block
    ...
    public static function doCountJoinLayout(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(BlockPeer::LAYOUT_ID, LayoutPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Block objects pre-filled with their Layout objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinLayout(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Block) to $obj2 (Layout)
                $obj2->addBlock($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Block) to the collection in $obj2 (Layout)
                $obj2->addBlock($obj1);
    ...
    /**
     * Deletes all rows from the keeko_block table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
