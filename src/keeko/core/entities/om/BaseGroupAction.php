...
/**
 * Base class that represents a row from the 'keeko_group_action' table.
 *
 *
 *
 * @package    propel.generator.keeko.core.entities.om
 */
abstract class BaseGroupAction extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'keeko\\core\\entities\\GroupActionPeer';
     ...
     * @return GroupAction The current object (for fluent API support)
     */
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[] = GroupActionPeer::GROUP_ID;
        }
    ...
    public function setActionId($v)
    {
        ...
        if ($this->action_id !== $v) {
            $this->action_id = $v;
            $this->modifiedColumns[] = GroupActionPeer::ACTION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = GroupActionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GroupAction object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GroupActionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GroupActionQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GroupActionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GroupActionPeer::GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`group_id`';
        }
        if ($this->isColumnModified(GroupActionPeer::ACTION_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GroupActionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GroupActionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $keys = GroupActionPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupActionPeer::GROUP_ID)) $criteria->add(GroupActionPeer::GROUP_ID, $this->group_id);
        if ($this->isColumnModified(GroupActionPeer::ACTION_ID)) $criteria->add(GroupActionPeer::ACTION_ID, $this->action_id);
    ...
    {
        $criteria = new Criteria(GroupActionPeer::DATABASE_NAME);
        $criteria->add(GroupActionPeer::GROUP_ID, $this->group_id);
        $criteria->add(GroupActionPeer::ACTION_ID, $this->action_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of GroupAction (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GroupAction Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GroupActionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GroupActionPeer();
        }
    ...
    {
        return (string) $this->exportTo(GroupActionPeer::DEFAULT_STRING_FORMAT);
    }
