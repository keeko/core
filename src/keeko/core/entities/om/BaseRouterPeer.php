...
use keeko\core\entities\map\RouterTableMap;

/**
 * Base static class for performing query and update operations on the 'keeko_router' table.
 *
 *
 *
...
abstract class BaseRouterPeer
{
    ...
    const TABLE_NAME = 'keeko_router';

    /** the related Propel class for this table */
    const OM_CLASS = 'keeko\\core\\entities\\Router';

    /** the related TableMap class for this table */
    const TM_CLASS = 'keeko\\core\\entities\\map\\RouterTableMap';
    ...
    const CLASS_NAME = 'keeko_router.class_name';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Router objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (RouterPeer::ID, RouterPeer::NAME, RouterPeer::TITLE, RouterPeer::CLASS_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'TITLE', 'CLASS_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'title', 'class_name', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (RouterPeer::ID => 0, RouterPeer::NAME => 1, RouterPeer::TITLE => 2, RouterPeer::CLASS_NAME => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'TITLE' => 2, 'CLASS_NAME' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'title' => 2, 'class_name' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RouterPeer::CLASS_NAME);
        } else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to keeko_router
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseRouterPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \keeko\core\entities\map\RouterTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the keeko_router table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
