...
abstract class BaseUser extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'keeko\\core\\entities\\UserPeer';
     ...
     * @throws PropelException
     */
    public function getSubdivision(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSubdivision === null && ($this->subdivision_id !== null) && $doQuery) {
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aSubdivision instanceof Persistent) {
              $this->aSubdivision->clearAllReferences($deep);
            }
