...
/**
 * Base class that represents a row from the 'keeko_block_content' table.
 *
 *
 *
 * @package    propel.generator.keeko.core.entities.om
 */
abstract class BaseBlockContent extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'keeko\\core\\entities\\BlockContentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BlockContentPeer
     */
     ...
     * @return BlockContent The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BlockContentPeer::ID;
        }
    ...
    public function setBlockItemId($v)
    {
        ...
        if ($this->block_item_id !== $v) {
            ...
            $this->modifiedColumns[] = BlockContentPeer::BLOCK_ITEM_ID;
        }
    ...
    public function setActionId($v)
    {
        ...
        if ($this->action_id !== $v) {
            $this->action_id = $v;
            $this->modifiedColumns[] = BlockContentPeer::ACTION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = BlockContentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BlockContent object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BlockContentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BlockContentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BlockContentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BlockContentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(BlockContentPeer::BLOCK_ITEM_ID)) {
            $modifiedColumns[':p' . $index++]  = '`block_item_id`';
        }
        if ($this->isColumnModified(BlockContentPeer::ACTION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`action_id`';
        }

        $sql = sprintf(
            'INSERT INTO `keeko_block_content` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BlockContentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BlockContentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BlockContent'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BlockContent'][$this->getPrimaryKey()] = true;
        $keys = BlockContentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BlockContentPeer::ID)) $criteria->add(BlockContentPeer::ID, $this->id);
        if ($this->isColumnModified(BlockContentPeer::BLOCK_ITEM_ID)) $criteria->add(BlockContentPeer::BLOCK_ITEM_ID, $this->block_item_id);
        if ($this->isColumnModified(BlockContentPeer::ACTION_ID)) $criteria->add(BlockContentPeer::ACTION_ID, $this->action_id);
    ...
    {
        $criteria = new Criteria(BlockContentPeer::DATABASE_NAME);
        $criteria->add(BlockContentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of BlockContent (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BlockContent Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BlockContentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BlockContentPeer();
        }
    ...
    public function getBlockItem(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBlockItem === null && ($this->block_item_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBlockItem->addBlockContents($this);
             */
        }
    ...
    public function getAction(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAction === null && ($this->action_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAction->addBlockContents($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BlockContentPeer::DEFAULT_STRING_FORMAT);
    }
