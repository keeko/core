...
abstract class BaseBlockGridQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'keeko\\core\\entities\\BlockGrid';
        }
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new BlockGridQuery(null, null, $modelAlias);
    ...
    public function filterByProperty($propertyName, $propertyValue)
    {
      ...
      $propertyValue = BlockGridPeer::normalizePropertyValue($propertyValue);
    ...
    public function filterByPropertyWithDefault($propertyName, $propertyValue, $default)
    {
      $propertyName = BlockGridPeer::normalizePropertyName($propertyName);
      $propertyValue = BlockGridPeer::normalizePropertyValue($propertyValue);
      $default = BlockGridPeer::normalizePropertyValue($default);
