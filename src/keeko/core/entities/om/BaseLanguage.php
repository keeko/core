...
abstract class BaseLanguage extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'keeko\\core\\entities\\LanguagePeer';
     ...
     * @throws PropelException
     */
    public function getLanguageScope(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLanguageScope === null && ($this->scope_id !== null) && $doQuery) {
     ...
     * @throws PropelException
     */
    public function getLanguageType(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLanguageType === null && ($this->type_id !== null) && $doQuery) {
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aLanguageScope instanceof Persistent) {
              $this->aLanguageScope->clearAllReferences($deep);
            }
            if ($this->aLanguageType instanceof Persistent) {
              $this->aLanguageType->clearAllReferences($deep);
            }
