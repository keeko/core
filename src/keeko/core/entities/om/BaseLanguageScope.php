...
use keeko\core\entities\LanguageScopeQuery;

/**
 * Base class that represents a row from the 'keeko_language_scope' table.
 *
 *
 *
 * @package    propel.generator.keeko.core.entities.om
 */
abstract class BaseLanguageScope extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'keeko\\core\\entities\\LanguageScopePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LanguageScopePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LanguageScopePeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = LanguageScopePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            throw new PropelException("Error populating LanguageScope object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LanguageScopePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LanguageScopeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LanguageScopePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LanguageScopePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LanguageScopePeer::NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LanguageScopePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LanguageScopePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $keys = LanguageScopePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LanguageScopePeer::ID)) $criteria->add(LanguageScopePeer::ID, $this->id);
        if ($this->isColumnModified(LanguageScopePeer::NAME)) $criteria->add(LanguageScopePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(LanguageScopePeer::DATABASE_NAME);
        $criteria->add(LanguageScopePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LanguageScope (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LanguageScope Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LanguageScopePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LanguageScopePeer();
        }
     ...
     * If this LanguageScope is new, it will return
     ...
     * @return PropelObjectCollection|Language[] List of Language objects
     */
    public function getLanguagesJoinLanguageType($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LanguageQuery::create(null, $criteria);
        $query->joinWith('LanguageType', $join_behavior);
    ...
    {
        return (string) $this->exportTo(LanguageScopePeer::DEFAULT_STRING_FORMAT);
    }
