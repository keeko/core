...
abstract class BaseCountry extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'keeko\\core\\entities\\CountryPeer';
     ...
     * @throws PropelException
     */
    public function getTerritory(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTerritory === null && ($this->territory_iso_nr !== null) && $doQuery) {
    ...
    {
        if ($this->aCurrency === null && ($this->currency_iso_nr !== null) && $doQuery) {
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aTerritory instanceof Persistent) {
              $this->aTerritory->clearAllReferences($deep);
            }
