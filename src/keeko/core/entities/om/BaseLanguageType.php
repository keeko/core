...
/**
 * Base class that represents a row from the 'keeko_language_type' table.
 *
 *
 *
 * @package    propel.generator.keeko.core.entities.om
 */
abstract class BaseLanguageType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'keeko\\core\\entities\\LanguageTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LanguageTypePeer
     */
     ...
     * @return LanguageType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LanguageTypePeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = LanguageTypePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = LanguageTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LanguageType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LanguageTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LanguageTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LanguageTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LanguageTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LanguageTypePeer::NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LanguageTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LanguageTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $keys = LanguageTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LanguageTypePeer::ID)) $criteria->add(LanguageTypePeer::ID, $this->id);
        if ($this->isColumnModified(LanguageTypePeer::NAME)) $criteria->add(LanguageTypePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(LanguageTypePeer::DATABASE_NAME);
        $criteria->add(LanguageTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LanguageType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LanguageType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LanguageTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LanguageTypePeer();
        }
     ...
     * If this LanguageType is new, it will return
    ...
    /**
     * Sets a collection of Language objects related by a one-to-many relationship
     ...
     * @throws PropelException
     */
    public function countLanguages(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collLanguagesPartial && !$this->isNew();
        if (null === $this->collLanguages || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collLanguages) {
    ...
    /**
     * @param	Language $language The language object to remove.
     * @return LanguageType The current object (for fluent API support)
     */
     ...
     * @return PropelObjectCollection|Language[] List of Language objects
     */
    public function getLanguagesJoinLanguageScope($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LanguageQuery::create(null, $criteria);
        $query->joinWith('LanguageScope', $join_behavior);
    ...
    {
        return (string) $this->exportTo(LanguageTypePeer::DEFAULT_STRING_FORMAT);
    }
