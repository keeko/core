...
use keeko\core\entities\map\GroupTableMap;

/**
 * Base static class for performing query and update operations on the 'keeko_group' table.
 *
 *
 *
...
abstract class BaseGroupPeer
{
    ...
    const ID = 'keeko_group.id';

    /** the column name for the user_id field */
    const USER_ID = 'keeko_group.user_id';

    /** the column name for the name field */
    const NAME = 'keeko_group.name';

    /** the column name for the is_guest field */
    const IS_GUEST = 'keeko_group.is_guest';

    /** the column name for the is_default field */
    const IS_DEFAULT = 'keeko_group.is_default';

    /** the column name for the is_active field */
    const IS_ACTIVE = 'keeko_group.is_active';

    /** the column name for the is_system field */
    const IS_SYSTEM = 'keeko_group.is_system';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Name', 'IsGuest', 'IsDefault', 'IsActive', 'IsSystem', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'name', 'isGuest', 'isDefault', 'isActive', 'isSystem', ),
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID, GroupPeer::USER_ID, GroupPeer::NAME, GroupPeer::IS_GUEST, GroupPeer::IS_DEFAULT, GroupPeer::IS_ACTIVE, GroupPeer::IS_SYSTEM, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'NAME', 'IS_GUEST', 'IS_DEFAULT', 'IS_ACTIVE', 'IS_SYSTEM', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'name', 'is_guest', 'is_default', 'is_active', 'is_system', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Name' => 2, 'IsGuest' => 3, 'IsDefault' => 4, 'IsActive' => 5, 'IsSystem' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'name' => 2, 'isGuest' => 3, 'isDefault' => 4, 'isActive' => 5, 'isSystem' => 6, ),
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID => 0, GroupPeer::USER_ID => 1, GroupPeer::NAME => 2, GroupPeer::IS_GUEST => 3, GroupPeer::IS_DEFAULT => 4, GroupPeer::IS_ACTIVE => 5, GroupPeer::IS_SYSTEM => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'NAME' => 2, 'IS_GUEST' => 3, 'IS_DEFAULT' => 4, 'IS_ACTIVE' => 5, 'IS_SYSTEM' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'name' => 2, 'is_guest' => 3, 'is_default' => 4, 'is_active' => 5, 'is_system' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupPeer::IS_GUEST);
            $criteria->addSelectColumn(GroupPeer::IS_DEFAULT);
            $criteria->addSelectColumn(GroupPeer::IS_ACTIVE);
            $criteria->addSelectColumn(GroupPeer::IS_SYSTEM);
        } else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to keeko_group
