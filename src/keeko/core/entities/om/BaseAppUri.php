...
/**
 * Base class that represents a row from the 'keeko_app_uri' table.
 *
 *
 *
 * @package    propel.generator.keeko.core.entities.om
 */
abstract class BaseAppUri extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'keeko\\core\\entities\\AppUriPeer';
     ...
     * @return AppUri The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AppUriPeer::ID;
        }
    ...
    public function setHttphost($v)
    {
        ...
        if ($this->httphost !== $v) {
            $this->httphost = $v;
            $this->modifiedColumns[] = AppUriPeer::HTTPHOST;
        }
    ...
    public function setBasepath($v)
    {
        ...
        if ($this->basepath !== $v) {
            $this->basepath = $v;
            $this->modifiedColumns[] = AppUriPeer::BASEPATH;
        }
    ...
    public function setSecure($v)
    {
        ...
        if ($this->secure !== $v) {
            $this->secure = $v;
            $this->modifiedColumns[] = AppUriPeer::SECURE;
        }
    ...
    public function setAppId($v)
    {
        ...
        if ($this->app_id !== $v) {
            $this->app_id = $v;
            $this->modifiedColumns[] = AppUriPeer::APP_ID;
        }
    ...
    public function setLocalizationId($v)
    {
        ...
        if ($this->localization_id !== $v) {
            ...
            $this->modifiedColumns[] = AppUriPeer::LOCALIZATION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->app_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            ...
            return $startcol + 6; // 6 = AppUriPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AppUri object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AppUriPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AppUriQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AppUriPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AppUriPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AppUriPeer::HTTPHOST)) {
            $modifiedColumns[':p' . $index++]  = '`httphost`';
        }
        if ($this->isColumnModified(AppUriPeer::BASEPATH)) {
            $modifiedColumns[':p' . $index++]  = '`basepath`';
        }
        if ($this->isColumnModified(AppUriPeer::SECURE)) {
            $modifiedColumns[':p' . $index++]  = '`secure`';
        }
        if ($this->isColumnModified(AppUriPeer::APP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`app_id`';
        }
        if ($this->isColumnModified(AppUriPeer::LOCALIZATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`localization_id`';
        }

        $sql = sprintf(
            'INSERT INTO `keeko_app_uri` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AppUriPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AppUriPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AppUri'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AppUri'][$this->getPrimaryKey()] = true;
        $keys = AppUriPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getHttphost(),
            $keys[2] => $this->getBasepath(),
            $keys[3] => $this->getSecure(),
            $keys[4] => $this->getAppId(),
            $keys[5] => $this->getLocalizationId(),
        );
        if ($includeForeignObjects) {
            if (null !== $this->aApp) {
                $result['App'] = $this->aApp->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setAppId($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AppUriPeer::ID)) $criteria->add(AppUriPeer::ID, $this->id);
        if ($this->isColumnModified(AppUriPeer::HTTPHOST)) $criteria->add(AppUriPeer::HTTPHOST, $this->httphost);
        if ($this->isColumnModified(AppUriPeer::BASEPATH)) $criteria->add(AppUriPeer::BASEPATH, $this->basepath);
        if ($this->isColumnModified(AppUriPeer::SECURE)) $criteria->add(AppUriPeer::SECURE, $this->secure);
        if ($this->isColumnModified(AppUriPeer::APP_ID)) $criteria->add(AppUriPeer::APP_ID, $this->app_id);
        if ($this->isColumnModified(AppUriPeer::LOCALIZATION_ID)) $criteria->add(AppUriPeer::LOCALIZATION_ID, $this->localization_id);
    ...
    {
        $criteria = new Criteria(AppUriPeer::DATABASE_NAME);
        $criteria->add(AppUriPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of AppUri (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AppUri Clone of current object.
     * @throws PropelException
     */
     ...
     * @throws PropelException
     */
    public function getApp(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aApp === null && ($this->app_id !== null) && $doQuery) {
    ...
    public function getLocalization(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLocalization === null && ($this->localization_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLocalization->addAppUris($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aApp instanceof Persistent) {
              $this->aApp->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(AppUriPeer::DEFAULT_STRING_FORMAT);
    }
