...
class LanguageTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'keeko.core.entities.map.LanguageTypeTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('keeko\\core\\entities\\LanguageType');
    ...
    {
        $this->addRelation('Language', 'keeko\\core\\entities\\Language', RelationMap::ONE_TO_MANY, array('id' => 'type_id', ), null, null, 'Languages');
    } // buildRelations()
