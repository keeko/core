...
class TerritoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'keeko.core.entities.map.TerritoryTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('keeko\\core\\entities\\Territory');
    ...
    {
        $this->addRelation('Country', 'keeko\\core\\entities\\Country', RelationMap::ONE_TO_MANY, array('iso_nr' => 'territory_iso_nr', ), null, null, 'Countrys');
    } // buildRelations()
