...
/**
 * Automatically generated JsonResponder for Reads the relationship of activity to target
 * 
 * @author gossi
 */
class ActivityTargetJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->target($payload->getModel());
