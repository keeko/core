...
/**
 * Automatically generated JsonResponder for List all language-scripts
 * 
 * @author gossi
 */
class LanguageScriptListJsonResponder extends AbstractPayloadResponder {
	...
	public function found(Request $request, Found $payload) {
		...
		$resource = $resource->with($params->getInclude(['language', 'localization']));
