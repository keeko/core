...
/**
 * Automatically generated JsonResponder for Reads the relationship of localization to script
 * 
 * @author Thomas Gossmann
 */
class LocalizationScriptJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->script($payload->getModel());
