...
/**
 * Automatically generated JsonResponder for Reads the relationship of activity_object to activity
 * 
 * @author Thomas Gossmann
 */
class ActivityObjectActivityJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->activities($payload->getModel());
