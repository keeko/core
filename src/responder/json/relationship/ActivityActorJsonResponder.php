...
/**
 * Automatically generated JsonResponder for Reads the relationship of activity to actor
 * 
 * @author gossi
 */
class ActivityActorJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->actor($payload->getModel());
