...
/**
 * Automatically generated JsonResponder for List all language-scopes
 * 
 * @author gossi
 */
class LanguageScopeListJsonResponder extends AbstractPayloadResponder {
	...
	public function found(Request $request, Found $payload) {
		...
		$resource = $resource->with($params->getInclude(['language']));
